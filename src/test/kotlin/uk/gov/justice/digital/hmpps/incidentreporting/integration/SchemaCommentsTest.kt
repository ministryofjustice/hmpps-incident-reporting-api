...
/**
 * Guards the data dictionary published to GitHub Pages (see db/migration/V1_48__schema_comments.sql).
 *
...
class SchemaCommentsTest : SqsIntegrationTestBase() {
  ...
  fun `every column description carries a sensitivity classification`() {
    ...
    assertThat(misclassified)
      .describedAs("column comments must end with one of $SENSITIVITY - see V1_48__schema_comments.sql")
      .isEmpty()
  }
