  ...
  inner class MigrateReport {
    ...
    val syncRequest = NomisSyncRequest(
      ...
      incidentReport = NomisReport(
        ...
        staffParties = listOf(NomisStaffParty(reportingStaff, NomisCode("PAS", "Present at scene"), "REPORTER")),
        ...
        questions = listOf(
          NomisQuestion(
            ...
            "Question 1",
            listOf(
              NomisResponse(1, 1, "Answer 1", "comment 1", reportingStaff),
              NomisResponse(1, 2, "Answer 2", "comment 2", reportingStaff),
              NomisResponse(1, 3, "Answer 3", "comment 3", reportingStaff),
            ),
          ),
          NomisQuestion(
            2,
            ...
            "Question 2",
            listOf(
              NomisResponse(2, 1, "Answer 1", "comment 1", reportingStaff),
              NomisResponse(2, 2, "Answer 2", "comment 2", reportingStaff),
              NomisResponse(2, 3, "Answer 3", "comment 3", reportingStaff),
            ),
          ),
          NomisQuestion(
            3,
            ...
            "Question 3",
            listOf(
              NomisResponse(3, 1, "Answer 1", "comment 1", reportingStaff),
              NomisResponse(3, 2, "Answer 2", "comment 2", reportingStaff),
              NomisResponse(3, 3, "Answer 3", "comment 3", reportingStaff),
            ),
          ),
        ),
        history = listOf(
          NomisHistory(
            ...
            questions = listOf(
              NomisHistoryQuestion(
                ...
                "Question 1",
                listOf(
                  NomisHistoryResponse(1, 1, "Answer 1", "comment 1", reportingStaff),
                  NomisHistoryResponse(1, 2, "Answer 2", "comment 2", reportingStaff),
                  NomisHistoryResponse(1, 3, "Answer 3", "comment 3", reportingStaff),
                ),
              ),
              NomisHistoryQuestion(
                2,
                ...
                "Question 2",
                listOf(
                  NomisHistoryResponse(2, 1, "Answer 1", "comment 1", reportingStaff),
                  NomisHistoryResponse(2, 2, "Answer 2", "comment 2", reportingStaff),
                  NomisHistoryResponse(2, 3, "Answer 3", "comment 3", reportingStaff),
                ),
              ),
              NomisHistoryQuestion(
                3,
                ...
                "Question 3",
                listOf(
                  NomisHistoryResponse(3, 1, "Answer 1", "comment 1", reportingStaff),
                  NomisHistoryResponse(3, 2, "Answer 2", "comment 2", reportingStaff),
                  NomisHistoryResponse(3, 3, "Answer 3", "comment 3", reportingStaff),
                ),
              ),
            ),
          ),
