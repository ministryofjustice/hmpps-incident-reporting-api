  ...
  inner class GetReports {
    ...
    inner class Validation {
      ...
      fun `cannot get too large a page of reports`() {
        webTestClient.get().uri("$url?size=1001")
          .headers(setAuthorisation(roles = listOf("ROLE_VIEW_INCIDENT_REPORTS"), scopes = listOf("read")))
          .header("Content-Type", "application/json")
          .exchange()
      ...
      inner class WhenManyReportsExist {
        ...
        @CsvSource(
          value = [
            ...
            "involvingPrisonerNumber=A0002AA&involvingPrisonerRole=ASSAILANT                                 | 2",
            "involvingPrisonerNumber=A0002AA&involvingPrisonerRole=ABSCONDER                                 | 0",
            "involvingPrisonerNumber=A0002AA&involvingPrisonerRole=ABSCONDER&involvingPrisonerRole=ASSAILANT | 2",
