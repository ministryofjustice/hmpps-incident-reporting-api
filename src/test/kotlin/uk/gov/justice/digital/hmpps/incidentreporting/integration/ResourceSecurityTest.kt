...
class ResourceSecurityTest : SqsIntegrationTestBase() {
  ...
  private val unprotectedDefaultMethods = setOf(
    ...
    "GET /constants/errorCodes",
    "GET /constants/informationSource",
    "GET /constants/prisonerOutcomes",
    "GET /constants/prisonerRoles",
    "GET /constants/staffRoles",
    "GET /constants/statuses",
    "GET /constants/types",
    "GET /constants/typeFamilies",
    "GET /constants/userActions",
    "GET /constants/userTypes",
