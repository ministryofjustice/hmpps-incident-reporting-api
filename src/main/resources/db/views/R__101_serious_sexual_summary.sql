...
create materialized view report.serious_sexual_assault_summary_view as
...
create index if not exists serious_sexual_assault_summary_view_idx
  on report.serious_sexual_assault_summary_view (report_id, incident_date_and_time, location);
