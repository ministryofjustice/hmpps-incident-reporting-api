...
data class TypeFamilyConstantDescription(
  @Schema(description = "Machine-readable identifier of this family", example = "DRONE_SIGHTING")
  val code: String,
  @Schema(description = "Human-readable description of this family", example = "Drone sighting")
