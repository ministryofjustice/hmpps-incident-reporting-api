...
fun <T : Any, V : Any> KProperty1<T, V?>.buildSpecForEqualTo(value: V): Specification<T> =
  Specification { root, _, criteriaBuilder ->
    criteriaBuilder.equal(root.get<V>(name), value)
  }

/** Build «in» specification from an entity’s property */
fun <T : Any, V> KProperty1<T, V>.buildSpecForIn(values: Collection<V>): Specification<T> {
...
fun <T : Any, V : Comparable<V>> KProperty1<T, V>.buildSpecForLessThan(value: V): Specification<T> {
  return Specification { root, _, criteriaBuilder ->
...
fun <T : Any, V : Comparable<V>> KProperty1<T, V>.buildSpecForGreaterThanOrEqualTo(value: V): Specification<T> {
  return Specification { root, _, criteriaBuilder ->
...
fun <T : Any, R, V> KProperty1<T, Collection<R>>.buildSpecForRelatedEntityPropertyEqualTo(
