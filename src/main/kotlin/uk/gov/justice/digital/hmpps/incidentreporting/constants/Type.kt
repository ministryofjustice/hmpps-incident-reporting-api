...
enum class Type(
  ...
  BC_DISRUPT_3RD_PTY_1(TypeFamily.BC_DISRUPT_3RD_PTY, "DIS_3RD_PTY"),
  BC_FUEL_SHORTAGE_1(TypeFamily.BC_FUEL_SHORTAGE, "FUELSHORTAGE"),
  BC_LOSS_ACCESS_EGRESS_1(TypeFamily.BC_LOSS_ACCESS_EGRESS, "LOSS_EGRESS"),
  BC_LOSS_COMMS_1(TypeFamily.BC_LOSS_COMMS, "LOSS_COMMS"),
  BC_LOSS_UTILS_1(TypeFamily.BC_LOSS_UTILS, "LOSS_UTILS"),
  BC_SERV_WEATHER_1(TypeFamily.BC_SERV_WEATHER, "SERV_WEATHER"),
  BC_STAFF_SHORTAGES_1(TypeFamily.BC_STAFF_SHORTAGES, "STF_SHORTAGE"),
  BC_WIDESPREAD_ILLNESS_1(TypeFamily.BC_WIDESPREAD_ILLNESS, "WSPR_ILLNESS"),
  ...
  KEY_OR_LOCK_3(TypeFamily.KEY_OR_LOCK, "KEY_LOCK3"),
  ...
  TOOL_LOSS_2(TypeFamily.TOOL_LOSS, "TOOL_LOSS2"),
