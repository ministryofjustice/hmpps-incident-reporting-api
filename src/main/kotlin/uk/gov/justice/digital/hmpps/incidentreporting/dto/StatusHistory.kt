...
data class StatusHistory(
  @param:Schema(description = "Previous status of an incident report")
  val status: Status,
  @param:Schema(description = "When the report status was changed", example = "2024-04-29T12:34:56.789012")
  val changedAt: LocalDateTime,
  @param:Schema(description = "The member of staff who changed the report status")
